...
urlpatterns = [
    ...
    path('consumer_register/<str:market>/', views.RegisterView.as_view(), name='register_request'),
    path('consumer_register/<str:market>/done/', views.RegisterDoneView.as_view(), name='register_request_done'),

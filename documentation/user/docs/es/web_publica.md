...
![Web pública, mercados](../assets/images/web-publica-mercados.png){ loading=lazy }
...
<p id="web-entidades"></p>
![Web pública, entidades Navarra](../assets/images/web-publica-entidades-nav.png){ loading=lazy }

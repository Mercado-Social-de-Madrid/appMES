...
![Noticias y ofertas destacadas](../../assets/destacados-lista.png){ loading=lazy align=left  width=330px }
![Detalle de noticia](../../assets/destacados-detalle.png){ loading=lazy align=left  width=330px }

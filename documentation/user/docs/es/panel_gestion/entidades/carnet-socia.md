...
![Panel entidad comprobar socia](../../../assets/images/panel-entidad-comprobar-socia.png){ loading=lazy }

De forma similar a las consumidoras, se tiene acceso a su carnet en formato digital y para descarga en PDF
imprimible.

![Panel entidad carnet](../../../assets/images/panel-entidad-carnet.png){ loading=lazy }
